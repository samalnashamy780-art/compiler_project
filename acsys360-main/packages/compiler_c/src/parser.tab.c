...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_INTEGER_LITERAL = 6,        /* TOK_INTEGER_LITERAL  */
  YYSYMBOL_TOK_REAL_LITERAL = 7,           /* TOK_REAL_LITERAL  */
  YYSYMBOL_TOK_PROGRAM = 8,                /* TOK_PROGRAM  */
  YYSYMBOL_TOK_CONST = 9,                  /* TOK_CONST  */
  YYSYMBOL_TOK_TYPE = 10,                  /* TOK_TYPE  */
  YYSYMBOL_TOK_VAR = 11,                   /* TOK_VAR  */
  YYSYMBOL_TOK_PROCEDURE = 12,             /* TOK_PROCEDURE  */
  YYSYMBOL_TOK_BY_VALUE = 13,              /* TOK_BY_VALUE  */
  YYSYMBOL_TOK_BY_REF = 14,                /* TOK_BY_REF  */
  YYSYMBOL_TOK_PRINT = 15,                 /* TOK_PRINT  */
  YYSYMBOL_TOK_READ = 16,                  /* TOK_READ  */
  YYSYMBOL_TOK_IF = 17,                    /* TOK_IF  */
  YYSYMBOL_TOK_THEN = 18,                  /* TOK_THEN  */
  YYSYMBOL_TOK_ELSE = 19,                  /* TOK_ELSE  */
  YYSYMBOL_TOK_REPEAT = 20,                /* TOK_REPEAT  */
  YYSYMBOL_TOK_WHILE = 21,                 /* TOK_WHILE  */
  YYSYMBOL_TOK_DO = 22,                    /* TOK_DO  */
  YYSYMBOL_TOK_AGAIN = 23,                 /* TOK_AGAIN  */
  YYSYMBOL_TOK_FROM = 24,                  /* TOK_FROM  */
  YYSYMBOL_TOK_TO = 25,                    /* TOK_TO  */
  YYSYMBOL_TOK_STEP = 26,                  /* TOK_STEP  */
  YYSYMBOL_TOK_UNTIL = 27,                 /* TOK_UNTIL  */
  YYSYMBOL_TOK_TYPE_INT = 28,              /* TOK_TYPE_INT  */
  YYSYMBOL_TOK_TYPE_REAL = 29,             /* TOK_TYPE_REAL  */
  YYSYMBOL_TOK_TYPE_BOOL = 30,             /* TOK_TYPE_BOOL  */
  YYSYMBOL_TOK_TYPE_CHAR = 31,             /* TOK_TYPE_CHAR  */
  YYSYMBOL_TOK_TYPE_STRING = 32,           /* TOK_TYPE_STRING  */
  YYSYMBOL_TOK_ARRAY = 33,                 /* TOK_ARRAY  */
  YYSYMBOL_TOK_RECORD = 34,                /* TOK_RECORD  */
  YYSYMBOL_TOK_TRUE = 35,                  /* TOK_TRUE  */
  YYSYMBOL_TOK_FALSE = 36,                 /* TOK_FALSE  */
  YYSYMBOL_TOK_EQ = 37,                    /* TOK_EQ  */
  YYSYMBOL_TOK_NE = 38,                    /* TOK_NE  */
  YYSYMBOL_TOK_LE = 39,                    /* TOK_LE  */
  YYSYMBOL_TOK_GE = 40,                    /* TOK_GE  */
...
static const char *const yytname[] =
{
  ...
  "TOK_STRING_LITERAL", "TOK_CHAR_LITERAL", "TOK_INTEGER_LITERAL",
  "TOK_REAL_LITERAL", "TOK_PROGRAM", "TOK_CONST", "TOK_TYPE", "TOK_VAR",
  "TOK_PROCEDURE", "TOK_BY_VALUE", "TOK_BY_REF", "TOK_PRINT", "TOK_READ",
  "TOK_IF", "TOK_THEN", "TOK_ELSE", "TOK_REPEAT", "TOK_WHILE", "TOK_DO",
  "TOK_AGAIN", "TOK_FROM", "TOK_TO", "TOK_STEP", "TOK_UNTIL",
